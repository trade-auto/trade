...
// 상대적 기울기 계산
export const calculateRelativeSlope = (ma: number[]) => {
...
// 볼린저 밴드 계산
export const calculateBollingerBands = (prices: number[], period: number = 20, multiplier: number = 2): { upper: number, middle: number, lower: number } | null => {
...
// 볼린저 밴드 신호 검사
export const isBollingerBandSignal = (prices: number[], period: number = 20, stdDev: number = 2): 'buy' | 'sell' | 'hold' => {
